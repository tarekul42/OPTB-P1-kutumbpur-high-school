import { studentProfile, attendanceData, noticeBoard, initialAssignments, scheduleData } from "@/shared/data/studentData";
import { Student, AttendanceData, Notice, Assignment, Schedule } from "@/shared/types/user";
