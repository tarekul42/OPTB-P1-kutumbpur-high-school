...
export const academicPrograms: ProgramWithIcon[] = [
  {
...
export const facultyFeatures: FeatureWithIcon[] = [
  {
...
export const facultyPortalFeatures: FeatureWithIcon[] = [
  {
    title: "Attendance Management",
    description: "Track and manage student attendance efficiently",
    icon: (
...
export const parentalFeatures: FeatureWithIcon[] = [
  {
...
export const parentalPortalFeatures: FeatureWithIcon[] = [
  {
    title: "Academic Progress",
...
export const studentFeatures: FeatureWithIcon[] = [
  {
...
export const studentPortalFeatures: FeatureWithIcon[] = [
  {
    title: "Course Materials",
...
export const updatesHomeNewsItems: NewsItemWithIcon[] = [
  {
...
export const updatesHomeAnnouncements: Announcement[] = [
  {
...
export const testimonialsAchievements: FeatureWithIcon[] = [
  {
...
export const homeFeatures: FeatureWithIcon[] = [
  {
    title: "Academic Excellence",
    description:
...
export const homeNews: NewsExcerpt[] = [
  {
...
export const contactOfficeHours: OfficeHoursItem[] = [
  { day: "Sunday - Thursday", hours: "10:00 AM - 4:00 PM" },
  { day: "Friday & Saturday", hours: "Weekly Holiday" },
];

export const aboutFeatures: FeatureWithIcon[] = [
  {
...
export const updatesNewsItems: NewsItemWithIcon[] = [
  {
...
export const updatesAnnouncements: Announcement[] = [
  {
    title: "Summer Vacation Schedule",
    content:
...
export const aboutUsFeatures: FeatureWithIcon[] = [
  {
    title: "Excellence in Education",
    description:
      "Committed to providing quality education with a focus on holistic development.",
...
export const aboutUsStats: AboutStatItem[] = [
  {
    value: "25+",
    label: "Years of Excellence",
    icon: (
...
export const academicsPrograms: ProgramWithSvgIcon[] = [
  {
    title: "Junior Secondary (Class 6-8)",
    description:
...
export const admissionSteps: AdmissionStepItem[] = [
  {
...
export const digitalResources: DigitalResourceItem[] = [
  {
    title: "E-Library",
    description:
...
export const LibraryCollections: LibraryCollectionItem[] = [
  {
...
export const eventsCalendarUpcomingEvents: CalendarEvent[] = [
  {
    title: "Annual Sports Day",
    date: "March 25, 2024",
    time: "9:00 AM - 4:00 PM",
...
export const eventsCalendarEventCategories: EventCategory[] = [
...
export const alumniSectionAlumniStories: AlumniStory[] = [
  {
    name: "Dr. Ahmed Ullah",
    year: "Class of 2010",
