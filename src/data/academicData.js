...
export const academicsDetailedPrograms = [
  {
    title: "Junior Secondary (Class 6-8)",
    description:
...
export const admissionSteps = [
  ...
  },
  {
    ...
    description: "Scheduled assessment for class placement and eligibility.",
    icon: "✍️",
  },
  {
    title: "Interview",
    description: "Personal interaction with the student and parents.",
    icon: "🤝",
  },
  {
    title: "Final Registration",
    description: "Submission of documents and fee payment to secure the seat.",
    icon: "✅",
  },
];
