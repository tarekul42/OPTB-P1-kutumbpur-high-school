...
export const bangladeshHolidays = [
  // National Days
  {
    ...
    date: "2026-02-21",
    type: "public_holiday",
    description: "Martyred Intellectuals Day - Schools and offices remain closed to honor those who sacrificed their lives for the Bengali language.",
  ...
  },
  {
    ...
    date: "2026-03-26",
    type: "public_holiday",
    description: "National Independence Day celebrating Bangladesh's independence from Pakistan in 1971.",
  ...
  },
  {
    ...
    date: "2026-12-16",
    type: "public_holiday",
    description: "National Victory Day commemorating the victory in the Liberation War of Bangladesh.",
    bnTitle: "বিজয় দিবস"
  },
  ...
  // Cultural/New Year
  {
    ...
    date: "2026-04-14",
    type: "public_holiday",
    description: "First day of the Bengali calendar year, celebrated with colorful parades and cultural programs.",
    bnTitle: "পহেলা বৈশাখ"
  },
  ...
  // Religious Holidays - Islamic
  {
    ...
    date: "2026-05-15",
    type: "public_holiday",
    description: "Festival of Breaking Fast - marks the end of Ramadan. Schools closed for holidays.",
    bnTitle: "ঈদুল ফিতর"
  },
  {
    id: 6,
  ...
  },
  {
    ...
    date: "2026-05-27",
    type: "public_holiday",
    description: "Festival of Sacrifice - one of the most important Islamic holidays.",
    bnTitle: "ঈদুল আযহা"
  },
  {
    id: 9,
  ...
  // Hindu Religious Holidays
  {
    ...
    date: "2026-10-07",
    type: "public_holiday",
    description: "Major Hindu festival celebrating the victory of goddess Durga over evil. Schools may have modified schedules.",
    bnTitle: "দুর্গা পূজা"
  },
  {
    id: 12,
    ...
    date: "2026-08-30",
    type: "public_holiday",
    description: "Birthday of Lord Krishna, celebrated with devotional songs and rituals.",
  ...
  // Buddhist Religious Holidays
  {
    ...
    date: "2026-05-03",
    type: "public_holiday",
    description: "Birthday of Lord Buddha, celebrated by Buddhist communities across Bangladesh.",
  ...
  // Other Important Days
  {
    ...
    date: "2026-06-01",
    type: "public_holiday",
    description: "Celebrating the rights and well-being of children in Bangladesh.",
  ...
  },
  {
    ...
    date: "2026-08-15",
    type: "public_holiday",
    description: "To mourn the assassination of Bangabandhu Sheikh Mujibur Rahman and his family in 1975.",
...
export const schoolEvents = [
  {
    ...
    date: "2026-03-10",
    type: "school_event",
    description: "First unit test for all classes. Students must bring their exam materials.",
  ...
  },
  {
    ...
    date: "2026-03-25",
    type: "school_event",
    description: "Annual sports competition. All students are encouraged to participate. Parents welcome!",
  ...
  },
  {
    ...
    date: "2026-02-20",
    type: "school_event",
    description: "Special cultural program to commemorate Language Martyrs' Day. All students must attend.",
  ...
  },
  {
    ...
    date: "2026-07-15",
    type: "school_event",
    description: "Quarterly PTM to discuss student progress. All parents must attend.",
  ...
  },
  {
    ...
    date: "2026-12-01",
    type: "school_event",
    description: "Annual examination results will be published. Parents can collect report cards.",
  ...
  },
  {
    ...
    date: "2026-04-14",
    type: "school_event",
    description: "School celebration for Bengali New Year with cultural programs and rally.",
...
// Bengali day names
export const bengaliDays = ['রবিবার', 'সোমবার', 'মঙ্গলবার', 'বুধবার', 'বৃহস্পতিবার', 'শুক্রবার', 'শনিবার'];
