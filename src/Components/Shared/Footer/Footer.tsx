        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-slate-300 text-lg mb-8 max-w-md leading-relaxed">
              Empowering students in Chandina, Cumilla with quality education
              since 1996. We focus on academic excellence, moral values, and
              global citizenship.
            </p>
            <div className="flex space-x-4">
              {[1, 2, 3, 4].map((i) => (
                <div
                  key={i}
                  className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-accent-gold/20 transition-colors cursor-pointer border border-white/5"
                >
          ...
          <div>
            <h4 className="text-xl font-serif font-bold text-accent-gold mb-6 uppercase tracking-wider">
              Quick Links
            </h4>
            <ul className="space-y-4">
              <li>
                ...
                >
                  <span className="w-0 group-hover:w-4 h-px bg-accent-gold transition-all mr-0 group-hover:mr-2"></span>
                  About Our School
                </Link>
              </li>
              <li>
