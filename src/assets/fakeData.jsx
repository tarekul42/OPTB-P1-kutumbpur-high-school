...
export const faqs = [
  ...
  },
  {
    ...
    answer:
      "The fee structure varies by class level. It includes tuition fees, development fees, and other charges. We offer various payment options and scholarships for meritorious students. For detailed fee structure, please contact our admission office.",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
  ...
  },
  {
    ...
    answer:
      "We offer a wide range of extracurricular activities including sports (cricket, football, basketball, athletics), arts (music, dance, drama), clubs (science, math, literature), and community service programs. These activities help in holistic development of students.",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
  ...
  },
  {
    ...
    answer:
      "Student safety is our top priority. We have CCTV surveillance, security personnel, strict entry/exit protocols, and regular safety drills. Our transportation system is GPS-enabled with trained drivers and attendants. We also have a comprehensive anti-bullying policy.",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
...
export const facultyPortalFeatures = [
  {
    title: "Attendance Management",
    description: "Track and manage student attendance efficiently",
    icon: (
...
export const parentalFeatures = [
  {
    ...
    description: "Track your child's academic performance and grades",
    icon: (
      <svg
        className="w-8 h-8"
        fill="none"
...
export const parentalPortalFeatures = [
  {
    title: "Academic Progress",
...
export const studentFeatures = [
  {
    ...
    description: "Access study materials and assignments",
    icon: (
      <svg
        className="w-8 h-8"
        fill="none"
  ...
  },
  {
    ...
    description: "Check your attendance and leave records",
    icon: (
      <svg
        className="w-8 h-8"
        fill="none"
...
export const studentPortalFeatures = [
  {
    title: "Course Materials",
    description: "Access your study materials and assignments",
    icon: (
      <svg
        className="w-8 h-8"
        fill="none"
...
export const updatesHomeNewsItems = [
  {
  ...
  },
  {
    ...
    description:
      "Our new state-of-the-art science laboratory is now open for students, equipped with modern equipment and facilities.",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Congratulations to our students who achieved outstanding results in the board examinations.",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
...
export const updatesHomeAnnouncements = [
  {
    title: "Summer Vacation Schedule",
    content:
      "School will remain closed from May 15 to June 30 for summer vacation.",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
...
export const testimonialsAchievements = [
  {
    title: "Academic Excellence",
    description:
      "Consistently high board examination results with 95% pass rate",
    icon: (
      <svg
        className="w-8 h-8"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Multiple district and state level championships in various sports",
    icon: (
      <svg
        className="w-8 h-8"
        fill="none"
...
export const aboutFeatures = [
  {
    ...
    description:
      "Committed to providing quality education with a focus on holistic development.",
    icon: (
      <svg
        className="w-8 h-8"
        fill="none"
...
export const updatesNewsItems = [
  {
    title: "Annual Sports Day Success",
    date: "March 15, 2024",
    category: "Events",
    description:
      "Our annual sports day was a grand success with record participation and outstanding performances.",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
  ...
  },
  {
    ...
    category: "Facilities",
    description:
      "State-of-the-art science laboratory inaugurated with modern equipment and facilities.",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
  ...
  },
  {
    ...
    category: "Achievements",
    description:
      "Congratulations to our students who received academic excellence awards for outstanding performance.",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
...
export const updatesAnnouncements = [
  {
    title: "Summer Vacation Schedule",
    content:
      "School will remain closed for summer vacation from May 15 to June 30, 2024.",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
  ...
  },
  {
    title: "Parent-Teacher Meeting",
    content:
      "Annual parent-teacher meeting scheduled for April 20, 2024. All parents are requested to attend.",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
...
export const admissionsRequiredDocuments = [
  "Birth Certificate",
...
export const upcomingEvents = [
  {
    ...
    description:
      "Join us for a day of athletic excellence and team spirit. Students will participate in various sports events and competitions.",
    category: "Sports",
  },
  {
    ...
    description:
      "Showcasing innovative projects and experiments by our talented students. Open to all parents and visitors.",
    category: "Academic",
  },
  {
    ...
    location: "School Auditorium",
    description:
      "A celebration of art, music, and dance featuring performances by our students.",
    category: "Cultural",
  },
];
...
export const digitalResources = [
  {
    title: "E-Library",
    description:
      "Access our digital library with thousands of books and journals",
    icon: (
      <svg
        className="w-8 h-8"
        fill="none"
...
export const LibraryCollections = [
  {
    ...
    description:
      "Comprehensive collection of textbooks and reference materials",
    icon: (
      <svg
        className="w-8 h-8"
        fill="none"
...
export const extracurricularActivities = [
  {
    title: "Sports",
    description:
      "Join our various sports teams including cricket, football, basketball, and athletics",
    icon: (
      <svg
        className="w-8 h-8"
        fill="none"
  ...
  },
  {
    title: "Arts & Culture",
    description:
      "Express yourself through music, dance, drama, and visual arts",
    icon: (
      <svg
        className="w-8 h-8"
        fill="none"
...
export const eventsCalendarUpcomingEvents = [
  {
    title: "Annual Sports Day",
    date: "March 25, 2024",
    time: "9:00 AM - 4:00 PM",
...
export const eventsCalendarEventCategories = [
