  ...
  return (
    <div className="min-h-screen bg-linear-to-b from-slate-50 to-surface">
      <div className="relative bg-secondary-800 overflow-hidden py-24">
        <div className="absolute inset-0 bg-linear-to-b from-secondary-800/40 via-transparent to-secondary-800/80 z-10"></div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-20">
          <div className="text-center">
            ...
            <p className="text-xl text-slate-100 max-w-3xl mx-auto font-medium drop-shadow-md">
              Monitor your child&apos;s academic journey at Kutumbpur High
              School. Track attendance, view results, and communicate with
              teachers.
            </p>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-linear-to-r from-secondary-800 to-secondary-700 rounded-xl shadow-lg p-8 text-white">
