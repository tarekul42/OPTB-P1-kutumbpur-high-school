...
const Attendance = () => {
  ...
  const getTileClassName = useCallback(
    ({ date, view }) => {
      ...
      if (status === "Present") return "bg-accent-100 text-accent-700 font-semibold rounded-lg";
      if (status === "Absent") return "bg-red-100 text-red-700 font-semibold rounded-lg";
      if (status === "Late") return "bg-amber-100 text-amber-700 font-semibold rounded-lg";
      if (status === "Leave") return "bg-yellow-100 text-yellow-700 font-semibold rounded-lg";
    ...
    <div className="space-y-6">
      <div className="bg-white rounded-2xl p-6 shadow-md">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            <div className="bg-gradient-to-br from-secondary-800 to-secondary-700 rounded-xl p-6 text-white">
            ...
            <div className="bg-slate-50 rounded-xl p-6">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-bold text-accent-600">{monthStats.present}</span>
                </div>
                <div className="flex justify-between items-center">
                  <div className="flex items-center gap-2">
                  ...
                  <span className="font-bold text-red-600">{monthStats.absent}</span>
                </div>
                <div className="flex justify-between items-center">
                  <div className="flex items-center gap-2">
                  ...
                  <span className="font-bold text-amber-600">{monthStats.late}</span>
                </div>
                <div className="flex justify-between items-center">
                  <div className="flex items-center gap-2">
                  ...
                  <span className="font-bold text-yellow-600">{monthStats.leave}</span>
                </div>
              </div>
            </div>
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-blue-700 mt-1">
              The attendance percentage shown is calculated based on school days (excluding Fridays and Saturdays).
              For any discrepancies or leave applications, please contact the school administration.
            </p>
          </div>
        </div>
      </div>
