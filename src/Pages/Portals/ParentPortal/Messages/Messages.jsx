...
const Messages = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (selectedTeacher && messageForm.subject && messageForm.message) {
      sendMessage(selectedTeacher.teacher, messageForm.subject, messageForm.message);
      closeModal();
    }
  };
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-secondary-200 text-sm">
              {selectedChild.class} | Class Teacher: {selectedChild.classTeacher}
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="p-4 bg-accent-50 rounded-xl border border-accent-200">
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              <p className="font-bold text-slate-800">{selectedChild.classTeacher}</p>
              <p className="text-sm text-slate-500">Class Teacher - {selectedChild.class}</p>
            </div>
            <button
              onClick={() =>
                openMessageModal({
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-amber-700 mt-1">
              For urgent matters or emergencies, please contact the school office directly at +880 1XXX-XXXXXX.
              Messages through this portal are typically responded to within 24-48 hours during school days.
            </p>
          </div>
        </div>
      </div>
