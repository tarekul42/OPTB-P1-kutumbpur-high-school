        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <h2 className="text-xl font-serif font-bold">{selectedChild.name}</h2>
              <p className="text-secondary-200 text-sm">{selectedChild.class} | {selectedChild.studentId}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-white rounded-xl p-6 shadow-md">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-2xl font-bold text-slate-800">৳{summary.paid.toLocaleString()}</p>
        ...
        <div className="bg-white rounded-xl p-6 shadow-md">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-2xl font-bold text-slate-800">৳{summary.pending.toLocaleString()}</p>
        ...
        <div className="bg-white rounded-xl p-6 shadow-md">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-2xl font-bold text-slate-800">৳{summary.totalAnnual.toLocaleString()}</p>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b-2 border-slate-200">
                  <th className="text-left py-3 px-4 font-bold text-slate-700">Quarter</th>
                  <th className="text-left py-3 px-4 font-bold text-slate-700">Period</th>
                  <th className="text-left py-3 px-4 font-bold text-slate-700">Due Date</th>
                  ...
                  <th className="text-center py-3 px-4 font-bold text-slate-700">Action</th>
                </tr>
              </thead>
              <tbody>
                {quarterly.map((fee) => (
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-blue-700 mt-1">
              Quarterly fees are due by the 15th of the first month of each quarter.
              A late fee of ৳100 will be applicable for payments made after the due date.
              Please contact the school office for any fee-related queries.
            </p>
          </div>
        </div>
      </div>
