    ...
    <div className="space-y-6">
      <div className="bg-white rounded-2xl p-6 shadow-md">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
          <div>
            <h2 className="text-2xl font-serif font-bold text-primary-900">Class Schedule</h2>
            <p className="text-slate-500 text-sm mt-1">Weekly class routine for {selectedDay}</p>
          </div>
            ...
            {currentDaySchedule.classes.map((classItem, index) => (
              ...
              >
                <div className="w-24 shrink-0">
                  <p className="text-sm font-semibold text-slate-800">{classItem.time}</p>
                </div>
                <div className={`px-4 py-2 rounded-lg border ${getSubjectColor(classItem.subject)}`}>
      ...
      <div className="bg-white rounded-2xl p-6 shadow-md">
        <h3 className="text-lg font-serif font-bold text-primary-900 mb-4">Subject Legend</h3>
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-blue-700 mt-1">
              Classes run from 8:00 AM to 2:00 PM. Each period is 1 hour with a 15-minute break between classes. 
              Friday is a half-day with special Islamic Studies classes in the afternoon.
            </p>
          </div>
        </div>
      </div>
