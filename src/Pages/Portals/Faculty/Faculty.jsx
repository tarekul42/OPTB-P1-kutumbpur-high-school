...
const Faculty = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-neutral-50 to-surface">
            {/* Hero Section */}
            <div className="relative bg-gradient-to-r from-accent-600 to-accent-800 text-white py-20">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="bg-surface rounded-xl shadow-lg p-8 border border-neutral-200">
                            ...
                            <div className="space-y-4">
                                <a href="#" className="flex items-center text-accent-600 hover:text-accent-700 transition-colors">
