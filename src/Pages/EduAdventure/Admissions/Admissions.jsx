    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-neutral-50 to-surface">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                {/* Admission Process */}
                <div className="mb-16">
                    <h2 className="text-3xl font-bold text-neutral-900 mb-8 text-center">Admission Process</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
                    <div className="bg-surface rounded-xl shadow-lg p-8 border border-neutral-200">
                        <h2 className="text-2xl font-bold text-neutral-900 mb-6">Required Documents</h2>
                    ...
                    <div className="bg-surface rounded-xl shadow-lg p-8 border border-neutral-200">
                        <h2 className="text-2xl font-bold text-neutral-900 mb-6">Important Dates</h2>
                        <div className="space-y-4">
                            <div className="flex justify-between items-center">
                                <span className="text-neutral-600">Application Period</span>
                                <span className="text-neutral-900 font-medium">January 1 - March 31</span>
                            </div>
                            <div className="flex justify-between items-center">
                ...
                {/* Call to Action */}
                <div className="text-center">
                    <h2 className="text-3xl font-bold text-neutral-900 mb-4">Ready to Join Us?</h2>
