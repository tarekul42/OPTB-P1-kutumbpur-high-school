            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2">
                        <h2 className="text-2xl font-bold text-neutral-900 mb-6">Latest News</h2>
                    ...
                    <div>
                        <h2 className="text-2xl font-bold text-neutral-900 mb-6">Announcements</h2>
                        <div className="space-y-6">
                            {announcements.map((announcement, index) => (
                                <div key={index} className="bg-surface rounded-xl shadow-lg p-6 border border-neutral-200">
                                    <div className="flex items-start">
                                        ...
                                        <div className="ml-4">
                                            <h3 className="text-lg font-bold text-neutral-900 mb-2">{announcement.title}</h3>
