            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    ...
                    <div className="space-y-8">
                            ...
                            <div className="space-y-4">
                                <div className="flex items-start">
                                    ...
                                    <div className="ml-3">
                                        ...
                                        <p className="text-sm text-neutral-600">123 School Street, Kutumbpur, West Bengal, India</p>
                                    </div>
                                </div>
                                <div className="flex items-start">
                                    <div className="flex-shrink-0">
                                    ...
                                    <div className="ml-3">
                                        ...
                                        <p className="text-sm text-neutral-600">+91 123 456 7890</p>
                                    </div>
                                </div>
                                <div className="flex items-start">
                                    <div className="flex-shrink-0">
                                    ...
                                    <div className="ml-3">
                                        ...
                                        <p className="text-sm text-neutral-600">info@kutumbpurhighschool.edu.in</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        {/* Office Hours */}
                        <div className="bg-surface rounded-xl shadow-lg p-8 border border-neutral-200">
                            <h2 className="text-2xl font-bold text-neutral-900 mb-6">Office Hours</h2>
                            <div className="space-y-2">
                                <div className="flex justify-between">
                                    <span className="text-neutral-600">Monday - Friday</span>
                                    <span className="text-neutral-900 font-medium">8:00 AM - 4:00 PM</span>
                                </div>
                                <div className="flex justify-between">
                ...
                {/* Map Section */}
                <div className="mt-16">
                    <div className="bg-surface rounded-xl shadow-lg overflow-hidden border border-neutral-200">
                        <iframe
