        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="flex flex-wrap gap-4">
                  {legendItems.map((item, index) => (
                    <div key={index} className="flex items-center gap-2">
                      <div
                        className={`w-6 h-6 rounded border-2 ${item.border} ${item.color}`}
                      ></div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 lg:p-8 sticky top-8">
              ...
              {/* Date Display */}
              <div className="mb-6 p-4 bg-linear-to-r from-rose-50 to-rose-100 rounded-lg">
              ...
              <div className="mt-6 p-4 bg-linear-to-r from-yellow-50 to-yellow-100 rounded-lg border border-yellow-200">
                <div className="flex items-start gap-3">
                  <svg
                    className="w-6 h-6 text-yellow-600 shrink-0 mt-1"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                  >
                    <path
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              ...
              <div className="space-y-3">
                ...
                <a
                  href="#all-holidays"
                  className="block text-center text-sm text-rose-600 hover:text-rose-800 font-medium mt-4"
                >
                  {language === "bn"
                    ? "সব ছুটি দেখুন →"
                    : "View All Holidays →"}
