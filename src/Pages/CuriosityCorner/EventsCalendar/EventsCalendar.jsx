        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-rose-100 max-w-3xl mx-auto">
              Stay updated with all school events, activities, and important
              dates.
            </p>
          </div>
        </div>
              ...
              {eventsCalendarUpcomingEvents.map((event, index) => (
                <div key={index} className="bg-white rounded-xl shadow-lg p-6">
                  <div className="flex items-start justify-between">
                    ...
                    <span
                      className={`px-3 py-1 rounded-full text-sm text-white ${event.category === "Sports" ? "bg-green-500" : event.category === "Academic" ? "bg-blue-500" : "bg-purple-500"}`}
                    >
                      {event.category}
                    </span>
                  </div>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              ...
              <div className="space-y-4">
                <a
                  href="#"
                  className="flex items-center text-rose-600 hover:text-rose-800"
                >
                  <svg
