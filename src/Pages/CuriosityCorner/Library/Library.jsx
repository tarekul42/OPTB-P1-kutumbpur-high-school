...
import { booksData, digitalResources, subjects, availabilityOptions } from "../../../data/booksData";
...
const Library = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      <div className="relative bg-gradient-to-r from-primary-900 via-primary-800 to-primary-900 py-24 overflow-hidden">
        ...
        <div className="mb-12">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2 bg-white rounded-xl p-1 border border-slate-200 shadow-sm">
              ...
              >
                <span className="flex items-center gap-2">
                  <svg className="w-5 h-5" fill={viewMode === "favorites" ? "currentColor" : "none"} stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-slate-200 pt-16">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
              Access our collection of online tutorials, PDFs, and e-books to enhance your learning experience
            </p>
          </div>
            ...
            {digitalResources.map((resource) => (
              ...
              >
                <div className="flex items-start gap-4">
                  <div className={`p-3 rounded-xl ${fileTypeColors[resource.fileType]} group-hover:scale-110 transition-transform`}>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center py-3 border-b border-primary-200">
                  <span className="text-slate-700 font-medium">Saturday - Thursday</span>
                  <span className="text-primary-800 font-bold">8:00 AM - 3:00 PM</span>
                </div>
                <div className="flex justify-between items-center py-3 border-b border-primary-200">
                ...
                <div className="flex justify-between items-center py-3">
                  <span className="text-slate-700 font-medium">Exam Season (Extended)</span>
                  <span className="text-primary-800 font-bold">Until 5:00 PM</span>
                </div>
              </div>
            </div>
