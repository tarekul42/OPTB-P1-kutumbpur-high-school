...
const Dashboard: React.FC = () => {
  ...
  const getAverageResult = (): string => {
    if (!results || results.length === 0) return "0";
    const total = results.reduce(
      (sum, r) => sum + r.firstTerm + r.secondTerm,
      0,
    );
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-secondary-200 mt-1">
              {selectedChild.class} | Section {selectedChild.section} | Roll:{" "}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white rounded-2xl p-6 shadow-md">
          <div className="flex items-center justify-between mb-6">
            <h3 className="font-serif font-bold text-lg text-secondary-900">
              Recent Results
            </h3>
            <Link
              ...
              >
                ...
                <div className="flex items-center gap-4">
                  <span className="text-sm text-slate-500">
                    1st: {result.firstTerm}
                  </span>
                  <span className="text-sm text-slate-500">
                    2nd: {result.secondTerm}
                  </span>
